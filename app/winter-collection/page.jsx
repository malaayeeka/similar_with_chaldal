  ...
  return (
    <>
      ...
      <div className="p-4 max-w-7xl mx-auto">
        ...
        {/* Products Grid - ইমেজ অনুযায়ী ৮ কলামের গ্রিড */}
          ...
          {winterProducts.map((p) => (
            ...
            >
              ...
              <div className="p-2 flex flex-col flex-grow text-center">
                ...
                {/* Add to Bag Button - Exact style as your image */}
                <div className="mt-auto">
                  <button className="w-full flex items-center justify-center gap-1 text-[13px] text-[#e04f54] font-semibold py-1.5 border-t border-gray-100 hover:bg-red-50 transition-colors">
                    <svg className="w-3 h-4 fill-current" viewBox="0 0 20 20">
                      <path d="M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.832 1.573l-7 11a1 1 0 01-1.632-.573l2-7H4a1 1 0 01-.832-1.573l7-11a1 1 0 011.132-.38z" />
                    </svg>
                    Add to bag
                  </button>
                </div>
