        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 mb-16">
          ...
          <div className="lg:col-span-6 flex flex-col items-end gap-6">
            ...
            <div className="flex gap-4">
              <Link href="#"><Image src="/googleplay.webp" alt="Google Play" width={135} height={40} /></Link>
              <Link href="#"><Image src="/appstore.webp" alt="App Store" width={135} height={40} /></Link>
            </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-8 gap-8 border-t border-gray-200">
          ...
          <div className="flex items-center gap-5 flex-wrap">
            ...
            <div className="flex gap-4 items-center">
               <Image src="/visa.png" alt="Visa" width={45} height={30} className="opacity-80 hover:opacity-100" />
               <Image src="/mastercard.png" alt="Mastercard" width={45} height={30} className="opacity-80 hover:opacity-100" />
               <Image src="/bkash.png" alt="Bkash" width={45} height={30} className="opacity-80 hover:opacity-100" />
            </div>
          </div>
